...
## <a name="Max">func</a> [Max](./pool.go?s=6836:6858#L300)
``` go
...
## <a name="Min">func</a> [Min](./pool.go?s=6938:6960#L308)
``` go
...
## <a name="Range">func</a> [Range](./pool.go?s=6733:6763#L295)
``` go
...
## <a name="Dispatcher">type</a> [Dispatcher](./dispatch.go?s=230:976#L17)
``` go
...
### <a name="NewDispatcher">func</a> [NewDispatcher](./dispatch.go?s=1019:1151#L53)
``` go
...
### <a name="Dispatcher.Closed">func</a> (\*Dispatcher) [Closed](./dispatch.go?s=2597:2631#L119)
``` go
...
### <a name="Dispatcher.DeWorker">func</a> (\*Dispatcher) [DeWorker](./dispatch.go?s=2779:2820#L127)
``` go
...
### <a name="Dispatcher.Run">func</a> (\*Dispatcher) [Run](./dispatch.go?s=1579:1605#L70)
``` go
...
### <a name="Pool.Closed">func</a> (\*Pool) [Closed](./pool.go?s=6442:6470#L281)
``` go
...
### <a name="Pool.SetLoadFactor">func</a> (\*Pool) [SetLoadFactor](./pool.go?s=5202:5246#L228)
``` go
...
### <a name="Pool.SetMaxPoolNum">func</a> (\*Pool) [SetMaxPoolNum](./pool.go?s=4959:5003#L217)
``` go
...
### <a name="Pool.SetResizePeriodSeconds">func</a> (\*Pool) [SetResizePeriodSeconds](./pool.go?s=5774:5836#L250)
``` go
...
### <a name="Pool.SetResizeSuccessThreshold">func</a> (\*Pool) [SetResizeSuccessThreshold](./pool.go?s=5470:5538#L239)
``` go
...
### <a name="Pool.Size">func</a> (\*Pool) [Size](./pool.go?s=6573:6598#L288)
``` go
...
### <a name="Pool.Undispatch">func</a> (\*Pool) [Undispatch](./pool.go?s=6095:6132#L262)
``` go
